...
export default function Input({ id, label, ...props }: InputProps) {
  return (
    ...
    autofill:pb-2"
      ...
      <label
        htmlFor={id}
        className="absolute top-2.5 start-0 py-4 px-0 h-full sm:text-sm truncate pointer-events-none transition ease-in-out duration-100 border border-transparent  origin-[0_0]  peer-disabled:opacity-50 peer-disabled:pointer-events-none
      peer-focus:scale-90
